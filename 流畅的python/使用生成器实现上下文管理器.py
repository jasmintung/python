...
def looking_glass():
    ...
    yield 'ZHANGTONG'  # 产出的这个值会绑定到with语句中as子句的目标变量上。执行with块中的代码时,这个函数会在这一点暂停。
    sys.stdout.write = original_write  # 控制权跳出with块,继续执行yield语句之后的代码


with looking_glass() as what:
    print('zhangtong, boy and it')  # ti dna yob ,gnotgnahz
    print(what)  # GNOTGNAHZ

print(what)  # ZHANGTONG
