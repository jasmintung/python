# Generated by Django 2.1 on 2018-10-11 08:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('asset_obj', models.ForeignKey(blank=True, null=True, on_delete=None, to='repository.Asset')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete=None, to='repository.Asset')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='creator',
            field=models.ForeignKey(blank=True, null=True, on_delete=None, to='repository.UserProfile'),
        ),
        migrations.AddField(
            model_name='asset',
            name='business_unit',
        ...
        migrations.AddField(
            ...
            name='user_info',
            field=models.OneToOneField(on_delete=None, to='repository.UserProfile'),
        ),
    ]
