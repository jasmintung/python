...
class UserInfo(models.Model):
    ...
    avatar = models.ImageField(upload_to='img', verbose_name='头像', default="img/default.png")
...
class Blog(models.Model):
    ...
    site = models.CharField(verbose_name='个人博客前缀', max_length=128, unique=True)
...
class UpDown(models.Model):
    ...
    user = models.ForeignKey(verbose_name='赞或踩用户', to='UserInfo', to_field='nid', on_delete=None)
...
class Article(models.Model):
    ...
    blog = models.ForeignKey(verbose_name='所属博客', to='Blog', to_field='nid', on_delete=None)
    category = models.ForeignKey(verbose_name='文章类型', to='Category', to_field='nid', null=True, on_delete=None)
